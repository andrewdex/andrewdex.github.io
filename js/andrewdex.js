...
phrase += "<div align='left' class='fontWhite'>Libraries, Issue Trackers, Frameworks / Dependency Managers: <span class='fontBlue'>JEE, JSE, Maven, Atlasian JiRA, QT C++, Node JS : GruntJS, ExpressJS, MeteorJS, NPM, jQuery</span></div>";
phrase += "<div align='left' class='fontWhite'>Version Controllers: <span class='fontBlue'>SVN, GIT, : GitHub , TFS</span></div>";
...
phrase += "<div align='left' class='fontWhite'>OS Literacy: <span class='fontBlue'>Linux : Fedora, Backtrack, Ubuntu, Windows 95 - 8, MAC Os, IOS, Android ... :) </span></div>";
